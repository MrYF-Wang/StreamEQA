...
def split_model(model_name):
    ...
    num_layers = {'InternVL3-8B': 32, 'InternVL3-26B': 48,
                  'InternVL3-40B': 60, 'InternVL3-Llama3-76B': 80}[model_name]
...
def InternVL_Init():
    ...
    path = os.environ.get("INTERNVL_MODEL_PATH", "/path/to/InternVL3-8B")
